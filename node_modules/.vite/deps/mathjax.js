    ...
    (function() {
      ...
      var __webpack_modules__ = { 444: function(t, e, r) {
        ...
        e.NodeMixinOptions = { badCSS: true, badSizes: true }, e.NodeMixin = function(t2, r2) {
          ...
          }(t2), n2.OPTIONS = i(i({}, r2.badCSS ? { fontSize: 16, fontFamily: "Times" } : {}), r2.badSizes ? { cjkCharWidth: 1, unknownCharWidth: 0.6, unknownCharHeight: 0.8 } : {}), n2.cjkPattern = new RegExp(["[", "ᄀ-ᅟ", "〈〉", "⺀-〾", "぀-㉇", "㉐-䶿", "一-꓆", "ꥠ-ꥼ", "가-힣", "豈-﫿", "︐-︙", "︰-﹫", "！-｠￠-￦", "𛀀-𛀁", "🈀-🉑", "𠀀-𿿽", "]"].join(""), "gu"), n2;
        };
      }, 6191: function(t, e, r) {
...
export default require_node_main();
